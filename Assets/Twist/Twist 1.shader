...
////// Lighting:
////// Emissive:
                float2 node_4989 = (i.uv0*2.0+-1.0).rg;
                float node_9933_ang = ((1.0 - saturate(length(node_4989)))*_Twist);
